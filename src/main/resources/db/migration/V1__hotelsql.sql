...
(
    ...
    client_check_in     VARCHAR(255)                             NOT NULL,
    client_check_out    VARCHAR(255)                             NOT NULL,
    client_phone_number VARCHAR(50)                              NOT NULL,
    client_email        VARCHAR(50)                              NOT NULL,
    client_hotel_id     INTEGER,
...
(
    ...
    rooms_type_current_type VARCHAR(255)                             NOT NULL,
    rooms_type_room_id      INTEGER,
    hotel_id                INTEGER                                  NOT NULL,
    CONSTRAINT pk_rooms_type PRIMARY KEY (rooms_type_id)
);

ALTER TABLE hotel_schema.client
    ADD CONSTRAINT uc_client_client_hotel UNIQUE (client_hotel_id);
...
ALTER TABLE hotel_schema.client
    ADD CONSTRAINT FK_CLIENT_ON_CLIENT_HOTEL FOREIGN KEY (client_hotel_id) REFERENCES hotel_schema.hotel (hotel_id);

ALTER TABLE hotel_schema.rooms_type
    ADD CONSTRAINT FK_ROOMS_TYPE_ON_HOTEL FOREIGN KEY (hotel_id) REFERENCES hotel_schema.hotel (hotel_id);

ALTER TABLE hotel_schema.rooms_type
    ADD CONSTRAINT FK_ROOMS_TYPE_ON_ROOMS_TYPE_ROOM FOREIGN KEY (rooms_type_room_id) REFERENCES hotel_schema.room (room_id);

ALTER TABLE hotel_schema.room
    ADD CONSTRAINT FK_ROOM_ON_ROOM_ROOMS_TYPE FOREIGN KEY (room_rooms_type_id) REFERENCES hotel_schema.rooms_type (rooms_type_id);