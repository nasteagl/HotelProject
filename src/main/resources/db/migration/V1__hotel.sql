...
ALTER TABLE hotel.client
    ADD CONSTRAINT FK_CLIENT_ON_HOTEL FOREIGN KEY (hotel_id) REFERENCES hotel.hotel (hotel_id);

ALTER TABLE hotel.rooms_type
    ADD CONSTRAINT FK_ROOMS_TYPE_ON_HOTEL FOREIGN KEY (hotel_id) REFERENCES hotel.hotel (hotel_id);

ALTER TABLE hotel.rooms_type
    ADD CONSTRAINT FK_ROOMS_TYPE_ON_ID_ROOM FOREIGN KEY (id_room) REFERENCES hotel.room (id_room);

ALTER TABLE hotel.room
    ADD CONSTRAINT FK_ROOM_ON_ID_ROOMS_TYPE FOREIGN KEY (id_rooms_type) REFERENCES hotel.rooms_type (id_rooms_type);
